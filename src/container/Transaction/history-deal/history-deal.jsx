...
import columns from './HdealColumns'

const FormItem = Form.Item

@Form.create()
@connect(state => ({
    Historydeal: state.Historydeal,
}))
export default class Historydeal extends React.Component {
    ...
    fetch = payload => {
        this.props.dispatch({
            type: 'Historydeal/fetchHdealsAsync',
            payload,
        })
    }
    onPagination = next => {
    ...
    render() {
        const { Historydeal } = this.props
        const { getFieldDecorator } = this.props.form
        const { Hdeals, pageNo, pageSize, total } = Historydeal
