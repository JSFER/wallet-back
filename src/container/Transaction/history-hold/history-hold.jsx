...
import columns from './HholdColumns'

const FormItem = Form.Item

@Form.create()
@connect(state => ({
    Historyhold: state.Historyhold,
}))
export default class Historyhold extends React.Component {
    ...
    fetch = payload => {
        this.props.dispatch({
            type: 'Historyhold/fetchHholdsAsync',
            payload,
        })
    }
    onPagination = next => {
    ...
    render() {
        const { Historyhold } = this.props
        const { getFieldDecorator } = this.props.form
        const { Hholds, pageNo, pageSize, total } = Historyhold
