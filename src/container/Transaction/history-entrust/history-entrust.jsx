...
import columns from './HentrustColumns'

const FormItem = Form.Item

@Form.create()
@connect(state => ({
    Historyentrust: state.Historyentrust,
}))
export default class Historyentrust extends React.Component {
    ...
    fetch = payload => {
        this.props.dispatch({
            type: 'Historyentrust/fetchHentrustsAsync',
            payload,
        })
    }
    onPagination = next => {
    ...
    render() {
        const { Historyentrust } = this.props
        const { getFieldDecorator } = this.props.form
        const { Hentrusts, pageNo, pageSize, total } = Historyentrust
